...
echo "  All of this is COMPLETELY REVERSIBLE via: bash scripts/uninstall.sh"
echo ""
...
echo ""
echo "  To uninstall (zero residue): bash scripts/uninstall.sh"
echo "  To verify:                   bash scripts/doctor.sh"
echo ""
